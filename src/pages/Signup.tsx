        ...
        <div className="hidden lg:flex flex-col justify-center space-y-6 p-8">
          <div>
            ...
            <p className="text-muted-foreground mb-8">
              Our users have seen an average 87% increase in interview callbacks after optimizing their resumes.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-foreground">Instant ATS compatibility analysis</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-success" />
              <span className="text-foreground">AI-powered keyword optimization</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-success" />
              <span className="text-foreground">Real-time resume editor</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-success" />
              <span className="text-foreground">Multi-format export options</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-success" />
              <span className="text-foreground">Job-specific optimization</span>
            </div>
          </div>
